...
function OrientNoClassError(dbName, className) {
...
util.inherits(OrientNoClassError, OrientError);
...
exports.OrientNoClassError = OrientNoClassError;
...
function parseJavaError(input) {
    ...
    return {
        message: errorParts && errorParts[2],
