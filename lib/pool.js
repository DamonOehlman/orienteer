...
OrientSocket.prototype.connect = function(connection, callback) {
    ...
    this.once('connect', function() {
        ...
        socket.once('data', function(buffer) {
            ...
            socket.send(commandData, function(err, response) {
...
*/
OrientSocket.prototype.send = function(data, callback) {
    // build the request buffer
    var socket = this,
        buffer = this._buildRequest(data),
        responseMapping,
        response,
    ...
    try {
        responseMapping = require('./response-mappings/' + data.command);
    }
    catch (e) {
        return callback(e);
    }
...
*/
OrientSocket.prototype._buildRequest = function(data) {
    var buffer,
    ...
    this.protocol.writeData(data, requestMapping, buffer, commandId, this.sessionId);
